...
class CarAdapter(private var cars: LiveData<List<Car>>, private val listener: OnAdapterListener) : RecyclerView.Adapter<CarAdapter.CarViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CarViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            findViewById<TextView>(R.id.tv_category).text = cars.value?.get(position)?.category ?:""
            findViewById<TextView>(R.id.tv_price).text = cars.value?.get(position)?.price.toString() ?:""
        }
        // tkan tombol pensil
